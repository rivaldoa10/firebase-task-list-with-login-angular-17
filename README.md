...
Este proyecto implementa la funcionalidad de un login y creacion de una lista de tareas  haciendo uso de Angular, firebase authentication y firestore.

Puede acceder al publicado del proyecto en esta enlace: https://task-list-login.web.app.
...
3-Cambie los datos de configuracion que aparece en el archivo app.config.ts por los datos su configuracion de firebase
